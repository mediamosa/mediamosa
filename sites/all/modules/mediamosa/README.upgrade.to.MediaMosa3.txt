...
Go into the administratino site and visit the MediaMosa-Configuration-Servers page,
edit the STILL server and change 'PATH'-field. Change the /still to /media, to
...
1. Backup your current installation, thats the www root, your MediaMosa
mountpoint (/srv/mediamosa/) and your 'mediamosa' database.
...
your settings.php. Follow these instructions carefully.
